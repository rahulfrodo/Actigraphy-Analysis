...
We fit a function-on-scalar regression (FOSR) model analyzing dependence of diurnal mean activity on adstatus (AD/CNC) and adjusting for age, sex and education. We use the pffr function in "refund" package for implementation of FOSR.
...
#save(mfpcafit,file="mfpcafit.RData")   #save this data after running mfpca
```
