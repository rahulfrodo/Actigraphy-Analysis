...
morning (10 a.m) to late afternoon (4-5 p.m). We fit a function-on-scalar regression (FOSR) model analyzing dependence of diurnal mean activity on adstatus (AD/CNC) and adjusting for age, sex and education. We use the pffr function in "refund" package for implementation of FOSR.
...
**Remark:** 
We also used diurnal quantile activity profiles (95th perrcentile) which showed similar patterns and predictive performance in both FOSR and SOFR modelling as SD_activity.
