...
![](E:/JHUPD/Paper1/sd final results/demtable1.JPG)
...
summary(fit.lf1,xlab="t",ylab=expression(paste(beta(t))))
plot(fit.lf1,xlab="t",ylab=expression(paste(beta(t))))
abline(h=0)
fit.lf2 <- pfr(VM~ age+Sex+education+lf(actmat,argvals=(binmid/60), k=12, bs="ps",m=2),data = subjdf)
summary(fit.lf2)
plot(fit.lf2,xlab="t",ylab=expression(paste(beta(t))))
abline(h=0)
fit.lf3 <- pfr(ExecFunction~ age+Sex+education+lf(actmat,argvals=(binmid/60), k=12, bs="ps",m=2),data = subjdf)
summary(fit.lf3)
plot(fit.lf3,xlab="t",ylab=expression(paste(beta(t))))
abline(h=0)
```
...
summary(fit.lf)
plot(fit.lf,xlab="p",ylab=expression(paste(beta(p))))
abline(h=0)
```
...
plot(fit.lf3,xlab="p",ylab=expression(paste(beta(p))))
abline(h=0)
```
